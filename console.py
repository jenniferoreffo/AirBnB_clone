...
class HBNBCommand(cmd.Cmd):
    ...
    def help_help(self):
        """ prints help command desc """
        print("Provides description of a given command")

    def emptyline(self):
        """ do nothing when linr is empty """
        pass

    def do_count(self, cls_name):
        """ counts number of instsnces """
        count = 0
    ...
    def do_create(self, type_model):
        """ Creates an instance according to a class """
        if not type_model:
    ...
    def do_show(self, args):
        """ String representation of an instance passed """
        if not arg:
            print("** class name missing **")
            return
        args = arg.split(' ')
    ...
    def do_all(self, arg):
        """" prints string reprrsentation of all instamces """
        if not arg:
            print("** class name missing **")
            return
    ...
    def do_update(self, arg):
        """ updates class name based onninstance and id """
        if not arg:
            print("** class name missing **")
            return
    ...
    def do_EOF(self, line):
        """ EOF command to exit command interpreter """
        return True
